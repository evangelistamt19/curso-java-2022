...
//MESMO CODIGO DO EX MAS PRA USAR O FOREACH NO LUGAR NO FOR NORMAL 
...
public class ExercicioDois {
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(notas)); // nesse caso é usado o metodo toString que passa o array para uma
													// string e poder ser exibida
